...
git push
```
запускается набор блоков команд jobs (см. файл [backend.yml](https://github.com/Osokin-Nikita/foodgram-project-react/blob/master/.github/workflows/backend.yml), т.к. команда `git push` является триггером workflow проекта.  

Клонируйте репозиторий и перейдите в него в командной строке:
```
git clone https://github.com/Osokin-Nikita/foodgram-project-react.git
cd backend
```
...
http://51.250.31.176/api/docs/redoc.html
### Развёрнутый проект:
http://51.250.31.176
...
## Об авторе
[Nikita](https://github.com/Osokin-Nikita/)
